...
public class FuncionarioDto {
    ...
    public static FuncionarioDto toDto(Funcionario funcionario) {
        return funcionario == null ? null : new FuncionarioDto(funcionario);
    }

    public static List<FuncionarioDto> toDto(List<Funcionario> funcionarios) {
        return funcionarios == null ? null : funcionarios.stream().map(FuncionarioDto::new).toList();
    }

    public static Page<FuncionarioDto> toDto(Page<Funcionario> funcionarios) {
        return funcionarios == null ? null : funcionarios.map(FuncionarioDto::new);
    }
}
